...
class CustomCalendarSimpleView extends StatefulWidget {
  const CustomCalendarSimpleView(
      {Key? key,
  ...
  @override
  _CustomCalendarSimpleViewState createState() => _CustomCalendarSimpleViewState();
}

class _CustomCalendarSimpleViewState extends State<CustomCalendarSimpleView> {
  List<DateTime> dateList = <DateTime>[];
  DateTime currentMonthDate = DateTime.now();
  DateTime? startDate;
  DateTime? endDate;
  late bool selectYear;
  ...
  void setListOfDate(DateTime monthDate) {
    dateList.clear();
    final DateTime newDate = DateTime(currentYear, monthDate.month, 0);
              ...
              children: <Widget>[
                ...
                Expanded(
                  child: GestureDetector(
                    ...
                    child: Center(
                      child: Text(
                        DateFormat('MMMM, yyyy').format(currentMonthDate).replaceAll('January', 'Enero').replaceAll('February', 'Febrero').replaceAll('March', 'Marzo').replaceAll('April', 'Abril').replaceAll('May', 'Mayo').replaceAll('June', 'Junio').replaceAll('July', 'Julio').replaceAll('August', 'Agosto').replaceAll('September', 'Septiembre').replaceAll('October', 'Octubre').replaceAll('November', 'Noviembre').replaceAll('December', 'Diciembre'),
                        style: TextStyle(
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      const BorderRadius.all(Radius.circular(24.0)),
                      border: Border.all(
                        color: PaLaCasaAppTheme.Gray.withOpacity(0.12),
                      ),
                    ),
                    child: Material(
                      color: Colors.transparent,
                    ...
                    return GestureDetector(
                      onTap: () {
                        setState(() {
                          ...
                          selectYear=!selectYear!;
                          currentMonthDate = DateTime.utc(currentYear);
                          setListOfDate(currentMonthDate);
                        });
  ...
  List<Widget> getDaysNameUI() {
    List<String> listDay=['Lunes','Martes','Miercoles','Jueves','Viernes','Sabado','Domingo'];
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              color: startDate != null && endDate != null
                                  ...
                                  getIsInRange(date)
                                  ? PaLaCasaAppTheme.Orange.withOpacity(0.4)
                                  : Colors.transparent
                                  : Colors.transparent,
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              ...
                              boxShadow: getIsItStartAndEndDate(date)
                                  ? <BoxShadow>[
                                BoxShadow(
                                    color: PaLaCasaAppTheme.Gray.withOpacity(0.4),
                                    blurRadius: 4,
  ...
  List<Widget> getYearNoUI() {
    final List<Widget> noList = <Widget>[];
    int count = 0;
    for (int i = 0; i < yearList.length; i+5) {
      final List<Widget> listUI = <Widget>[];
      for (int j = 0; j < 5; j++) {
