...
class EditAddress extends StatefulWidget {
  ...
  @override
  State<EditAddress> createState() => _EditAddressState(address);
}
...
class _EditAddressState extends State<EditAddress> {
  ...
  _EditAddressState(this.address);
                            ...
                            child: InkWell(
                              onTap: () async {
                                ...
                                if(street.isNotEmpty) {
                                  if(parami){
                                    editAddressUser(
                                        id_municipality,street,alias, "", address.phone!,
                    ...
                    children: [
                      Container(
                        ...
                        child: ListTile(
                          ...
                          title: Text("Editar Dirección",style: TextStyle(fontFamily: PaLaCasaAppTheme.fontName,fontWeight: FontWeight.bold,fontSize: 18),),
                        ),
                      ),
                    ],
                  ),
  ...
  void currentLocationUser() async{
    _controllerAlias.text=address.alias!;
    _controllerDescripcion.text=address.street!;
    if(address.beneficiario!=null){
      _controllerName.text='${address.beneficiario!}';
    }else {
      _controllerName.text = '';
    }
    _controllerPhone.text=address.phone!;
    id_municipality=address.id_municipio!.toString();
    if(address.beneficiario!=null){
      parami=false;
    }
    ...
    currentLocation = LatLng(address.latituded!, address.longituded!);
  ...
  editAddressUser(String id_municipality,String street,String name,String beneficiario,String phone,String longituded,String latituded) async {
      setState(() {
        setRequest=true;
      });
    var request = http.MultipartRequest('POST', Uri.parse('https://palacasa.whizzlyshop.com/api/editAddress'))
      ..fields['id'] = address.id!.toString()
      ..fields['idp'] = address.id_select!.toString()
  ...
  deleteAddressUser() async {
    setState(() {
      setRequest=true;
    });
    var request = http.MultipartRequest('POST', Uri.parse('https://palacasa.whizzlyshop.com/api/deleteAddress'))
      ..fields['id'] = address.id!.toString()
      ..fields['idp'] = address.id_select!.toString();
                  ...
                  children: <Widget>[
                    Center(
                      child: Padding(
                        ...
                        child: Text(
                          "Eliminar Dirección".toUpperCase(),style: TextStyle(fontFamily: PaLaCasaAppTheme.fontNameRegular,fontWeight: FontWeight.bold,color: PaLaCasaAppTheme.Orange,fontSize: 16.0),
                    ...
                    Container(
                        ...
                        child: Center(child: Text('¿Desea eliminar esta dirección?',
                          style: TextStyle(
                              fontFamily: PaLaCasaAppTheme.fontNameRegular, fontWeight: FontWeight
                              .normal, color: PaLaCasaAppTheme.Gray, fontSize: 17.0),))),
                    SizedBox(
                      height: 5.0,
                    ),
                    Row(
