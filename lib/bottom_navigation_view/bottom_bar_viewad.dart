...
class _BottomBarViewState extends State<BottomBarViewAdmin>
                    ...
                    child: Container(
                      ...
                      child: Material(
                        ...
                        child: InkWell(
                          ...
                          onLongPress: widget.addLongClick,
                          child: Icon(
                            widget.iconData,
                            color: PaLaCasaAppTheme.white,
                            size: 22,
              ...
              children: <Widget>[
                ScaleTransition(
                  ...
                  child: widget.tabIconData!.isSelected
                      ?Icon(widget.tabIconData!.imagePath,color: PaLaCasaAppTheme.Orange,)
                      : Icon(widget.tabIconData!.imagePath,color: PaLaCasaAppTheme.grey.withOpacity(0.5),),
                ),
                Positioned(
                  top: 4,
                  left: 6,
